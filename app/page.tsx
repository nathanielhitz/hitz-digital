  ...
  <main style="position:relative;z-index:2;background:var(--bg2)">
    ...
    <section id="werk" data-screen-label="Werk" style="border-top:1px solid var(--line);padding:clamp(80px,12vw,140px) clamp(20px,5vw,64px)">
      <div class="hd-reveal" style="max-width:1140px;margin:0 auto">
        ...
        <div class="hd-work" style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px">
          <a href="#" style="text-decoration:none;color:inherit" style-hover="opacity:0.92"><div style="aspect-ratio:4/3;border-radius:13px;overflow:hidden;border:1px solid var(--line);background:repeating-linear-gradient(135deg,#16130f 0,#16130f 10px,#100e0b 10px,#100e0b 20px);position:relative"><div style="position:absolute;inset:0;background:radial-gradient(120% 90% at 30% 0%,color-mix(in srgb,var(--accent) 9%,transparent),transparent 60%)"></div><span style="position:absolute;bottom:12px;left:14px;font-family:ui-monospace,Menlo,monospace;font-size:10px;letter-spacing:0.08em;color:#a8a298">VOLMER TECHNIEK</span></div><div style="display:flex;justify-content:space-between;align-items:center;margin-top:14px"><span style="font-family:'General Sans',sans-serif;font-weight:600;font-size:16px">Volmer Techniek</span><span style="font-size:12px;color:var(--faint)">Industrie</span></div></a>
          <a href="#" style="text-decoration:none;color:inherit" style-hover="opacity:0.92"><div style="aspect-ratio:4/3;border-radius:13px;overflow:hidden;border:1px solid var(--line);background:repeating-linear-gradient(135deg,#16130f 0,#16130f 10px,#100e0b 10px,#100e0b 20px);position:relative"><div style="position:absolute;inset:0;background:radial-gradient(120% 90% at 70% 0%,color-mix(in srgb,var(--accent) 9%,transparent),transparent 60%)"></div><span style="position:absolute;bottom:12px;left:14px;font-family:ui-monospace,Menlo,monospace;font-size:10px;letter-spacing:0.08em;color:#a8a298">PROJECT · WEBSITE</span></div><div style="display:flex;justify-content:space-between;align-items:center;margin-top:14px"><span style="font-family:'General Sans',sans-serif;font-weight:600;font-size:16px">Atelier Noord</span><span style="font-size:12px;color:var(--faint)">Interieur</span></div></a>
          <a href="#" style="text-decoration:none;color:inherit" style-hover="opacity:0.92"><div style="aspect-ratio:4/3;border-radius:13px;overflow:hidden;border:1px solid var(--line);background:repeating-linear-gradient(135deg,#16130f 0,#16130f 10px,#100e0b 10px,#100e0b 20px);position:relative"><div style="position:absolute;inset:0;background:radial-gradient(120% 90% at 50% 0%,color-mix(in srgb,var(--accent) 9%,transparent),transparent 60%)"></div><span style="position:absolute;bottom:12px;left:14px;font-family:ui-monospace,Menlo,monospace;font-size:10px;letter-spacing:0.08em;color:#a8a298">PROJECT · WEBSITE</span></div><div style="display:flex;justify-content:space-between;align-items:center;margin-top:14px"><span style="font-family:'General Sans',sans-serif;font-weight:600;font-size:16px">Kustlijn</span><span style="font-size:12px;color:var(--faint)">Horeca</span></div></a>
        </div>
      </div>
    </section>
